...
gtsave(gtbl_site_covid_status,
       file.path(path.local.country.week.tables, paste0('gtbl_site_covid_status', '_', country, "_", week_report, '.png'))) %>%
  invisible()
...
ggsave(file.path(path.local.country.week.graphs, paste0('hist_epicurve_status', '_', week_report, '.png')),
...
ggsave(file.path(path.local.country.week.graphs, paste0('hist_epicurve_status_site', '_', week_report, '.png')),
...
gtsave(gtbl_consultation_admission,
       file.path(path.local.country.week.tables, paste0('gtbl_consultation_admission', '_', country, "_", week_report, '.png'))) %>%
  invisible()
...
ggsave(file.path(path.local.country.week.graphs, paste0('hist_epicurve_consult_admit', '_', country, "_", week_report, '.png')),
...
gtsave(gtbl_general_characteristics,
       file.path(path.local.country.week.tables, paste0('gtbl_general_characteristics','_', country, "_", week_report, '.png'))) %>%
  invisible()
...
gtsave(gtbl_general_characteristics_by_site,
       file.path(path.local.country.week.tables, paste0('gtbl_general_characteristics_by_site','_', country, "_", week_report, '.png'))) %>%
  invisible()
...
ggsave(file.path(path.local.country.week.graphs, paste0('plot_symptoms', '_', country, "_", week_report, '.png')),
       plot = plot_symptoms,
       width = 6, 
       height = 4, 
       scale = 1.1,
...
gtsave(gtbl_cfr_status_site,
       file.path(path.local.country.week.tables, paste0('gtbl_cfr_status_site','_', country, "_", week_report, '.png'))) %>%
  invisible()
...
ggsave(file.path(path.local.country.week.graphs, paste0('pyramid_age_sex_confirmed', '_', country, "_", week_report, '.png')),
...
ggsave(file.path(path.local.country.week.graphs, paste0('pyramid_age_sex_confirmed_site', '_', country, "_", week_report, '.png')),
...
df_severity <- dta_msf_linelist %>% 
  filter(age_group != "Unknown", MSF_covid_status %in% include_status) %>% 
  group_by(age_group) %>% 
  summarize(
    n = n(),
...
ggsave(file.path(path.local.country.week.graphs, paste0('dots_cfr_agegroup', '_', country, "_", week_report, '.png')),
...
ggsave(file.path(path.local.country.week.graphs, paste0('boxplot_delay_admission_week', '_', country, "_", week_report, '.png')),
...
ggsave(file.path(path.local.country.week.graphs, paste0('boxplot_length_stay_week', '_', country, "_", week_report, '.png')),
