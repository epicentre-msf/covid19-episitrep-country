...
gtsave(gtbl_site_covid_status,
       file.path(path.local.country.week.tables, paste0('gtbl_site_covid_status', '_', week_report, '.png'))) %>%
  invisible()
...
gtsave(gtbl_consultation_admission,
       file.path(path.local.country.week.tables, paste0('gtbl_consultation_admission', '_', week_report, '.png'))) %>%
  invisible()
...
gtsave(gtbl_general_characteristics,
       file.path(path.local.country.week.tables, paste0('gtbl_general_characteristics','_', week_report, '.png'))) %>%
  invisible()
...
gtsave(gtbl_general_characteristics_by_site,
       file.path(path.local.country.week.tables, paste0('gtbl_general_characteristics_by_site','_', week_report, '.png'))) %>%
  invisible()
...
gtsave(gtbl_cfr_status_site,
       file.path(path.local.country.week.tables, paste0('gtbl_cfr_status_site','_', week_report, '.png'))) %>%
  invisible()
...
ggsave(file.path(path.local.country.week.graphs, paste0('pyramid_age_sex_confirmed', '_', week_report, '.png')),
...
ggsave(file.path(path.local.country.week.graphs, paste0('pyramid_age_sex_confirmed_site', '_', week_report, '.png')),
...
ggsave(file.path(path.local.country.week.graphs, paste0('dots_cfr_agegroup', '_', week_report, '.png')),
...
ggsave(file.path(path.local.country.week.graphs, paste0('boxplot_delay_admission_week', '_', week_report, '.png')),
...
ggsave(file.path(path.local.country.week.graphs, paste0('boxplot_length_stay_week', '_', week_report, '.png')),
